...
export default function EditInvoiceForm(props: EditInvoiceFormProps) {
  const submission = useSubmission(updateInvoice);
  ...
  return (
    <form action={updateInvoice.with(props.invoice.id)} method="post">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <select
              ...
              value={props.invoice.customer_id}
            ...
            <div class="flex gap-4">
              <div class="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  checked={props.invoice.status === "pending"}
              ...
              <div class="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  checked={props.invoice.status === "paid"}
                  class="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 focus:ring-2"
                  aria-describedby="status-error"
                />
                <label
